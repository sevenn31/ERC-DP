...
class MyMapDataset(Dataset):
    def __init__(self, past_utterance,tokenizer, token_length, DEVICE):
        input_ids= meld_embeddings(
                past_utterance, tokenizer, token_length
        )
...
def meld_embeddings(past_utterance,tokenizer, token_length):
    input_ids = []
